...
function createUpdateActivity() {
    ...
    if (activityId && activityId != "0") {
        ...
        formDataUpdate.append("ExperienceTypeId", $('input[name="experience-type"]:checked').val());
        formDataUpdate.append("ExperienceCategoryId", $('#create-activity-category').val());
        formDataUpdate.append("SubCategoryId", $('#create-activity-sub-category').val());
        formDataUpdate.append("Title", replaceEmptyvalue($("#create-activity-title").val(), NOTHING_PROVIDED));
        formDataUpdate.append("Description", replaceEmptyvalue($("#create-activity-description").val(), NOTHING_PROVIDED));
        formDataUpdate.append("Price", replaceEmptyvalue(null, NOTHING_PROVIDED));
        formDataUpdate.append("ScheduleIndicator", replaceEmptyvalue(null, NOTHING_PROVIDED));
        formDataUpdate.append("Remarks", replaceEmptyvalue(null, NOTHING_PROVIDED));
        formDataUpdate.append("IsPublished", $('#activity-is-published').val() == 'true' ? true : false);
        formDataUpdate.append("Address1", replaceEmptyvalue($("#house-number").val(), NOTHING_PROVIDED));
        formDataUpdate.append("Address2", replaceEmptyvalue(null, NOTHING_PROVIDED));
        formDataUpdate.append("District", replaceEmptyvalue(null, NOTHING_PROVIDED));
        formDataUpdate.append("City", replaceEmptyvalue($("#city").val(), ""));
        formDataUpdate.append("Subdivision", replaceEmptyvalue(null, NOTHING_PROVIDED));
        formDataUpdate.append("Region", replaceEmptyvalue($("#region").val(), ""));
        formDataUpdate.append("Barangay", replaceEmptyvalue($("#barangay").val(), ""));
        formDataUpdate.append("PostalCode", replaceEmptyvalue($("#postal-code").val(), ""));
        formDataUpdate.append("PinnedLocation", replaceEmptyvalue($(".pinned-location").val(), NOTHING_PROVIDED));
        formDataUpdate.append("SpecificsYouWillProvide", replaceEmptyvalue(null, NOTHING_PROVIDED));
        formDataUpdate.append("CustomerBringWithThem", replaceEmptyvalue($('.ql-editor').html(), NOTHING_PROVIDED));
        formDataUpdate.append("AdditionalRequirements", replaceEmptyvalue(null, NOTHING_PROVIDED));
        ...
        formDataUpdate.append("SessionName", replaceEmptyvalue(null, NOTHING_PROVIDED));
        ...
        axios.postForm("api/activity/update", formDataUpdate)
            .then(response => {
...
function populateFormData() {
    ...
    formData.append("ExperienceTypeId", $('input[name="experience-type"]:checked').val());
    formData.append("ExperienceCategoryId", $('#create-activity-category').val() != 0 ? $('#create-activity-category').val() : 2);
    formData.append("SubCategoryId", $('#create-activity-sub-category').val() != null ? $('#create-activity-sub-category').val() : 51);
    ...
    formData.append("IsPublished", $('#activity-is-published').val() == 'true' ? true : false);
    ...
    formData.append("CustomerBringWithThem", replaceEmptyvalue($('.ql-editor').html(), NOTHING_PROVIDED));
    ...
    $('#activitySchedules .accordion-item .accordion-collapse .accordion-body').each(function () {
        ...
        formData.append("ActivitySchedules[" + scheduleCounter + "].UnitPrice", replaceEmptyvalue("PHP", NOTHING_PROVIDED));
        formData.append("ActivitySchedules[" + scheduleCounter + "].PerUnit1", 1);
        formData.append("ActivitySchedules[" + scheduleCounter + "].PriceUnit1", replaceEmptyvalue("Head", NOTHING_PROVIDED));
        formData.append("ActivitySchedules[" + scheduleCounter + "].PerUnit2", $(this).find('#unit2-input').val());

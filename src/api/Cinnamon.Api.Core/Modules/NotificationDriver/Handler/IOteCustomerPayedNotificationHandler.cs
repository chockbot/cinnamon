...
public interface IOteCustomerPayedNotificationHandler : IInteractorHandler<OteCustomerPayedNotificationArgs, AppResult<OteCustomerPayedNotificationResult>>
{
}
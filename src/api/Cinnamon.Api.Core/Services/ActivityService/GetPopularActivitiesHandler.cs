...
public class GetPopularActivitiesHandler : IGetPopularActivitiesHandler
{
    private readonly IActivityData activityData;
	public GetPopularActivitiesHandler(IActivityData activityData)
	{
	...
	public async Task<AppResult<GetAllActivitiesResult>> ExecuteAsync(GetAllActivitiesArgs args)
	{
		try
		{
			var result = await activityData.GetPopularActivities(new Framework.ApiCommand.ApiData.Activity.Request.GetAllActivities {

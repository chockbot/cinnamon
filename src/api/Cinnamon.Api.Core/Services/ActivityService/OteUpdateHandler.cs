        ...
        try
        {
            ...
            var entity = new Cinnamon.Framework.ApiCommand.ApiData.Activity.Request.UpdateOteActivityArgs {
                Activity = new Framework.ApiCommand.ApiData.Activity.Request.UpdateOteActivityArgs.UpdateOteActivity {
                    BarangayCode = args.Activity.BarangayCode,
                    BarangayName = args.Activity.BarangayName,
                    CategoryId = args.Activity.CategoryId,
                    CityName = args.Activity.CityName,
                    CityNumber = args.Activity.CityNumber,
                    ...
                    PinnedLocation = args.Activity.PinnedLocation,
                    PostalCode = args.Activity.PostalCode,
                    Recurrence = args.Activity.Recurrence,
                    RegionCode = args.Activity.RegionCode,

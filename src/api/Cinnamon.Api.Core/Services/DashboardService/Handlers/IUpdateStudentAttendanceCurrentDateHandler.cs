...
public interface IUpdateStudentAttendanceCurrentDateHandler : IInteractorHandler<UpdateStudentAttedanceCurrentDateArgs,AppResult<UpdateStudentAttendanceCurrentDateResult>>
{
}
...
public interface ICreateDirectStudentAttendanceHandler : IInteractorHandler<CreateDirectStudentAttendanceArgs, AppResult<CreateDirectStudentAttendanceResult>>
{
}

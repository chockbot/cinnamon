...
var dbConnectionString = "Host=seacinnamonprod.postgres.database.azure.com;Database=postgres;Username=adminuser;Password=Cinnamon_01"; //client.GetSecret(builder.Configuration.GetSection("KeyVault:CinnamonDbConnectionString").Value).Value.Value;

...
public class PurchaseOrderEntity : GenericEntity<PurchaseOrder>, IPurchaseOrder
{
	...
	public async Task<AppResult<IEnumerable<PurchaseOrder>>> GetGrossSalesByProvider(int? Id, DateTime? dateFrom)
	{
		try
		{
			...
			string query = "SELECT a.\"Id\", a.\"ActivityId\", a.\"ScheduleId\", a.\"CustomerId\", a.\"Total\", a.\"CreatedOn\", a.\"CreatedBy\",a.\"Status\", \r\n" +
				"a.\"Payload\",a.\"UnitCount\", a.\"UnitPrice\", a.\"AddOnsAmount\", a.\"CouponAmount\",(a.\"Total\" + a.\"AddOnsAmount\" - a.\"CouponAmount\") as \"OverAllTotal\"," +
				"b.\"CreatedBy\",b.\"Title\",b.\"Description\"\r\n" +
				...
				using (var dr = await command.ExecuteReaderAsync())
				{
					if (dr.HasRows)
					{
						...
						listResult = dt.AsEnumerable().Select(item => new PurchaseOrder
						{
						   ...
						   Total      = Convert.ToDecimal(item["OverAllTotal"]),
	...
	public async Task<AppResult<IEnumerable<DisburseStudentDTO>>> AddOnsNeedToDisburse()
	{
		...
		{
			return AppResult<IEnumerable<DisburseStudentDTO>>.CreateFailed(ex, "An error occured when trying to get addons need to disburse");
		}
	}
}
...
{
    Task<AppResult<IEnumerable<OteTicket>>> GetByActivityId(int activityId, int dateId, int? count, int? skip, bool includeCustomer = false, bool includeImageData = false);

...
public interface IOteTicketRepository 
{
    ...
    Task<AppResult<IEnumerable<OteTicketDTO>>> GetByActivityId(int activityId, int dateId, int? count, int? skip, bool includeCustomer = false, bool includeImageAsResult = false);

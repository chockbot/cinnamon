...
public interface IOteTicketRepository 
{
    ...
    Task<AppResult<IEnumerable<OteTicketDTO>>> GetByActivityId(int activityId, string searchValue , int searchBy, int? count, int? skip, bool includeCustomer = false, bool includeImageAsResult = false);

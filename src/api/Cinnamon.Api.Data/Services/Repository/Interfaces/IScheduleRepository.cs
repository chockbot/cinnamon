...
namespace Cinnamon.Api.Data.Services.Repository.Interfaces
{
    public interface IScheduleRepository
    {
        ...
        Task<AppResult<ScheduleDTO>> UpdateSchedule(int? ScheduleId, string? Name, string? datetime, decimal? Price, string? UnitPrice, int? PerUnit1, string? PriceUnit1, int? PerUnit2, string? PriceUnit2, int? order, bool? IsActiveSchedule);
        Task<AppResult<ScheduleDTO>> CreateSchedule(int ActivityId, string Name, string datetime, decimal Price, string UnitPrice, int PerUnit1, string PriceUnit1, int PerUnit2, string PriceUnit2, int order, bool IsActiveSchedule);
